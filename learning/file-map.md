...
- index.html — known (2026-08-05) — the app's page. Redesigned from scratch 2026-08-05: dark theme, per-quadrant accent colors (pink/gold/blue/green) applied to headers and custom circular checkboxes, fixed-height scrollable quadrant cards, responsive 1-column layout under 600px, hover/press states → [[html-structure]], [[css-layout]], [[css-class-selectors]], [[css-color-coding]], [[css-visual-design-pass]], [[event-listeners]], [[js-functions]], [[dom-manipulation]]
